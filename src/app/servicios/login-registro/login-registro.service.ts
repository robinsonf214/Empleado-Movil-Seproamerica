...
export class ClienteWAService {
   ...
   */
  /*Url del servidor */
  DJANGO_SERVER: string = "https://seproamerica2022.pythonanywhere.com/api/mobilRegistro";
  DJANGO_SERVER_INICIO_SESION: string = "https://seproamerica2022.pythonanywhere.com/api/mobilInicioSesion";
